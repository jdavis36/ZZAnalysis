LHE_Probabilities_MCFM = [
   "Name:SampleHypothesisMCFM Alias:<Name> Process:HSMHiggs Production:ZZGG MatrixElement:MCFM Couplings:kappa_top=1,0;kappa_bot=1,0;ghz1=0,0;ghzgs2=0.0477547,0 hmass:125 hwidth:0.00407 Cluster:NoInitialQ isGen:1 NoBranch:1", # Hide this branch
...
LHE_DecayProbabilities_SpinZero_JHUGen = [
   ...
   "Name:SampleHypothesisJHUGen Alias:<Name> Process:SelfDefine_spin0 Production:ZZGG MatrixElement:JHUGen Couplings:ghg2=1,0;ghz1=0,0;ghzgs2=0.0477547,0 Cluster:NoInitialQ isGen:1",
